...
# CONSTANTS
DRIVER_VERSION: str = "1.5.20241202+FelicityEss+JBD_Mod"
"""
...
DCL_ENABLE_HYSTERESIS: int = get_int_from_config("DEFAULT", "DCL_ENABLE_HYSTERESIS")
DCL_DISABLE_HYSTERESIS: int = get_int_from_config("DEFAULT", "DCL_DISABLE_HYSTERESIS")
